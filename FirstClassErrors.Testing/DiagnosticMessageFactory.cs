...
///     drawn from JustDummies' ambient random context, so a test wrapped in <c>JustDummies.Any.Reproducibly(...)</c> replays it.
/// </summary>
public static class DiagnosticMessageFactory {
    ...
    public static string Any() {
        return "Any diagnostic message " + JustDummies.Any.String().WithLength(6).Generate() + ".";
    }
