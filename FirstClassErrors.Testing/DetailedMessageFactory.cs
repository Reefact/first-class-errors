...
///     from JustDummies' ambient random context, so a test wrapped in <c>JustDummies.Any.Reproducibly(...)</c> replays it.
/// </summary>
public static class DetailedMessageFactory {
    ...
    public static string Any() {
        return "Any detailed message " + JustDummies.Any.String().WithLength(6).Generate() + ".";
    }
