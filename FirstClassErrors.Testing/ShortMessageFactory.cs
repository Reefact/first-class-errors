...
///     JustDummies' ambient random context, so a test wrapped in <c>JustDummies.Any.Reproducibly(...)</c> replays it.
/// </summary>
public static class ShortMessageFactory {
    ...
    public static string Any() {
        return "Any short message " + JustDummies.Any.String().WithLength(6).Generate() + ".";
    }
