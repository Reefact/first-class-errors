...
///     need <i>some</i> classification but do not assert on it. Drawn from JustDummies' ambient random context.
/// </summary>
public static class TransienceFactory {
    ...
    public static Transience Any() {
        return JustDummies.Any.Enum<Transience>().Except(Transience.Unknown).Generate();
    }
