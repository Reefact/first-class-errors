...
namespace Reefact.DiagnosableExceptions.Analyzer {
    ...
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ReefactDiagnosableExceptionsAnalyzerCodeFixProvider))]
    [Shared]
    public class ReefactDiagnosableExceptionsAnalyzerCodeFixProvider : CodeFixProvider {

        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(ReefactDiagnosableExceptionsAnalyzerAnalyzer.DiagnosticId);
