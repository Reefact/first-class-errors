...
[ErrorFor(typeof(BankTransactionFileValidator))]
public sealed class NonCompliantBankTransactionFileException : PrimaryAdapterException {
    ...
    private static ErrorDocumentation TransactionDateOutOfStatementPeriodDocumentation() {
        return Describe.Error(nameof(DateOutOfStatementPeriod))
                       .WithCode(Code.DateOutOfStatementPeriod)
                       .WithTitle("Transaction date outside statement period")
    ...
    private static ErrorDocumentation StatementTotalAmountMismatchDocumentation() {
        return Describe.Error(nameof(StatementTotalAmountMismatch))
                       .WithCode(Code.StatementTotalAmountMismatch)
                       .WithTitle("Statement total amount mismatch")
