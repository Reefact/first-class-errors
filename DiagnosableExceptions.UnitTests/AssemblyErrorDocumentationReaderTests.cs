...
namespace DiagnosableExceptions.UnitTests {
    ...
    public class AssemblyErrorDocumentationReaderTests {
        ...
        public void Test1() {
            ...
            Check.That(amountCurrencyMismatch.Diagnostics[0].Type).IsEqualTo(ErrorOrigin.Internal);
            ...
            Check.That(amountCurrencyMismatch.Diagnostics[1].Type).IsEqualTo(ErrorOrigin.InternalOrExternal);
            ...
            Check.That(bankTransactionFileDateOutOfStatementPeriod.Diagnostics[0].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(bankTransactionFileDateOutOfStatementPeriod.Diagnostics[1].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(bankTransactionFileDateOutOfStatementPeriod.Diagnostics[2].Type).IsEqualTo(ErrorOrigin.InternalOrExternal);
            ...
            Check.That(bankTransactionFileDateOutOfStatementPeriod.Diagnostics[3].Type).IsEqualTo(ErrorOrigin.Internal);
            ...
            Check.That(bankTransactionFileStatementTotalAmountMismatch.Diagnostics[0].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(bankTransactionFileStatementTotalAmountMismatch.Diagnostics[1].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(bankTransactionFileStatementTotalAmountMismatch.Diagnostics[2].Type).IsEqualTo(ErrorOrigin.InternalOrExternal);
            ...
            Check.That(bankTransactionFileStatementTotalAmountMismatch.Diagnostics[3].Type).IsEqualTo(ErrorOrigin.Internal);
            ...
            Check.That(temperatureBelowAbsoluteZero.Diagnostics[0].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(temperatureBelowAbsoluteZero.Diagnostics[1].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(temperatureBelowAbsoluteZero.Diagnostics[2].Type).IsEqualTo(ErrorOrigin.External);
            ...
            Check.That(temperatureBelowAbsoluteZero.Diagnostics[3].Type).IsEqualTo(ErrorOrigin.Internal);
            ...
            Check.That(temperatureBelowAbsoluteZero.Diagnostics[4].Type).IsEqualTo(ErrorOrigin.External);
