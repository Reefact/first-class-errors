...
public sealed class BindingContractTests {
    ...
    public void RequiredArgumentErrorCarriesItsMessages() {
        PrimaryPortError error = RequestBindingError.ArgumentRequired(RequestBindingError.DefaultArgumentRequired, "GuestEmail");
    ...
    public void InvalidArgumentErrorCarriesItsMessages() {
        PrimaryPortError error = RequestBindingError.ArgumentInvalid(RequestBindingError.DefaultArgumentInvalid, "GuestEmail", BookingDomainError.EmailInvalid("x"));
