...
public sealed class StructuralCodeOverrideTests {
    ...
    public void OptionsDefaultToTheStructuralCodes() {
        ...
        RequestBinderOptions namesOnly = new RequestBinderOptions(RequestBinderOptions.Default.ArgumentNameProvider);
    ...
    public void DefaultCodeStillRaisedWhenNotOverridden() {
        ...
        PropertySource<BookingRequest> body = bind.PropertiesOf(Request(guestEmail: null));
    ...
    public void CustomRequiredCodeOnMissingScalar() {
        RequestBinder bind = Bind.WithOptions(CustomCodes()).Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> body = bind.PropertiesOf(Request(guestEmail: null));
    ...
    public void CustomInvalidCodeOnInvalidScalar() {
        RequestBinder bind = Bind.WithOptions(CustomCodes()).Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> body = bind.PropertiesOf(Request(guestEmail: "not-an-email"));
    ...
    public void CustomCodesOnListElements() {
        RequestBinder bind = Bind.WithOptions(CustomCodes()).Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> body = bind.PropertiesOf(Request(tags: ["ok", null, "bad tag"]));
    ...
    public void CustomRequiredCodeOnMissingComplex() {
        RequestBinder bind = Bind.WithOptions(CustomCodes()).Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> body = bind.PropertiesOf(Request(stay: null));
    ...
    public void NestedBinderInheritsCustomCodes() {
        RequestBinder bind = Bind.WithOptions(CustomCodes()).Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> body = bind.PropertiesOf(Request(stay: new StayDto("not-a-date", null)));
    ...
    public void ConsumerBranchesSymbolically() {
        RequestBinder byDefault     = Bind.Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> byDefaultBody = byDefault.PropertiesOf(Request(guestEmail: null));
        ...
        RequestBinder overridden     = Bind.WithOptions(CustomCodes()).Request(BookingEnvelopeError.CommandInvalid);
        PropertySource<BookingRequest> overriddenBody = overridden.PropertiesOf(Request(guestEmail: null));
