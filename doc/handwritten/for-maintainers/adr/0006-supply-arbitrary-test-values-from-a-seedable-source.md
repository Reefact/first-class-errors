...
**Status:** Superseded by [ADR-0026](0026-rebase-testing-arbitrary-values-on-dummies.md)
**Date:** 2026-07-19
...
* `doc/handwritten/for-users/ArbitraryTestValues.en.md` — the guide where the new surface is documented.
