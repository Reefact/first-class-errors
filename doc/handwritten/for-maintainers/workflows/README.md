...
| [`dependabot-autofix`](dependabot-autofix.en.md) | Advisory Claude triage of a failing Dependabot PR: verdict + a ready-to-apply patch as one comment. Never pushes or merges. |
