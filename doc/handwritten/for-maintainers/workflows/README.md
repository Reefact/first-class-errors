...
| [`mutation`](mutation.en.md) | Mutation testing of the FirstClassErrors libraries with Stryker.NET — a required check on what a PR changed, plus a weekly full sweep. |
