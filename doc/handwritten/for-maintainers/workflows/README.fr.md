...
| [`mutation`](mutation.fr.md) | Tests de mutation des bibliothèques FirstClassErrors avec Stryker.NET — check obligatoire sur ce qu'une PR modifie, plus un balayage complet hebdomadaire. |
...
| [`dependabot-autofix`](dependabot-autofix.fr.md) | Claude trie une PR Dependabot en échec et pousse un correctif à faible risque — auto-merge conservé pour un correctif trivial (reword/retitle/rebase), désactivé pour un changement de code. Ne merge jamais. |
