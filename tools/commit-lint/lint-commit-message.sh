...
#   git log -1 --format=%B <sha> | lint-commit-message.sh -   # CI, per commit
#
...
# --- exemptions ---------------------------------------------------------------
# Merge commits (message generated by git/GitHub) and autosquash placeholders
# (rewritten by the later rebase) are not linted.
case "$subject" in
  'Merge '*) exit 0 ;;
