...
/// <summary>
///     The result of binding an optional reference-type property without a fallback: <see cref="Value" /> is the
///     bound value, or <c>null</c> when the argument was absent from the request.
/// </summary>
/// <remarks>
...
public sealed class OptionalReferenceProperty<TProperty> where TProperty : class {
    ...
    internal OptionalReferenceProperty(TProperty? value, Error? failure) {
        _value   = value;
        _failure = failure;
    }
