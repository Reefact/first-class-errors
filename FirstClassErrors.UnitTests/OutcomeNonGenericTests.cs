...
public sealed class OutcomeNonGenericTests {
    ...
    public void RecoverLeavesASuccessfulOutcomeUnchanged() {
        ...
        // Exercise
        Outcome result = outcome.Recover(_ => Outcome.Failure(new DomainError(ErrorCode.Unspecified, "fallback")));
    ...
    public void FinallyResolvesTheFailureBranchWhenTheOutcomeIsAFailure() {
        ...
        // Exercise
        string result = outcome.Finally(() => "ok", failure => $"ko:{failure.DetailedMessage}");
