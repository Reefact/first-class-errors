...
public sealed class ErrorDiagnosticTests {
    ...
    public void AnErrorDiagnosticCannotBeCreatedWithANullCause() {
        // Exercise & verify
        Check.ThatCode(() => new ErrorDiagnostic(null!, ErrorOriginFactory.Any(), StringFactory.AnyAnalysisLead()))
    ...
    public void AnErrorDiagnosticCannotBeCreatedWithANullAnalysisLead() {
        // Exercise & verify
        Check.ThatCode(() => new ErrorDiagnostic(StringFactory.AnyCause(), ErrorOriginFactory.Any(), null!))
             .Throws<ArgumentNullException>();
    }
    ...
    public void AnErrorDiagnosticCannotBeCreatedWithAnEmptyOrWhitespaceCause(string value) {
        // Exercise & verify
        Check.ThatCode(() => new ErrorDiagnostic(value, ErrorOriginFactory.Any(), StringFactory.AnyAnalysisLead()))
    ...
    public void AnErrorDiagnosticCannotBeCreatedWithAnEmptyOrWhitespaceAnalysisLead(string value) {
        // Exercise & verify
        Check.ThatCode(() => new ErrorDiagnostic(StringFactory.AnyCause(), ErrorOriginFactory.Any(), value))
             .Throws<ArgumentException>();
    }
    ...
    public void AnErrorDiagnosticTrimsTheCause() {
        // Exercise
        ErrorDiagnostic diagnostic = new("  Invalid input.  ", ErrorOriginFactory.Any(), StringFactory.AnyAnalysisLead());
    ...
    public void AnErrorDiagnosticTrimsTheAnalysisLead() {
        // Exercise
        ErrorDiagnostic diagnostic = new(StringFactory.AnyCause(), ErrorOriginFactory.Any(), "  Inspect payload  ");
